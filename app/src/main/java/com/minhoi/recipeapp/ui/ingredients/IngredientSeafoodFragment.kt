...
class IngredientSeafoodFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ingredient_seafood, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment IngredientSeafoodFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            IngredientSeafoodFragment().apply {
